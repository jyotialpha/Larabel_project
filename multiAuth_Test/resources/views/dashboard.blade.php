                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu border-0 shadow bsb-zoomIn" aria-labelledby="accountDropdown">
                                <li>
                                    <a class="dropdown-item" href="{{ route('acount.logout') }}">Logout</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
    ...
    <div class="container">
        <div class="card border-0 shadow my-5">
            ...
            <div class="card-body">
                ...
                <a href="{{ route('acount.details') }}" class="btn btn-primary">View Profile Details</a>
                <!-- Link to Update Password Form -->
                <a href="{{ route('acount.updatePasswordForm') }}" class="btn btn-secondary">Update Password</a>
            </div>
        </div>
    </div>
